...
public class DiskWorker {
    ...
    protected Boolean runInBackground() throws Exception {
         ...
         */
      // declare vars that will point to objects used to pass progress to UI
        ...
        if (App.readTest && App.writeTest && !benchmarkWorker.checkIsCancelled()) {
    ...
    protected void done() {
        ...
        try {
            lastStatus = benchmarkWorker.goGet();   // record for future access
        } catch (Exception e) {
